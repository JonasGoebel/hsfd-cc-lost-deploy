...
resource "local_file" "private_key_pem" {
  ...
  filename         = "${path.module}/../values/ssh_keys/generated_private_key.pem"
...
resource "local_file" "floating_ip" {
  ...
  filename = "${path.module}/../values/floating_ip/floating_ip.txt"
}
